    ...
    <div className="flex flex-col w-full h-full bg-[#121212] text-gray-200 overflow-hidden relative">
      ...
      <div className="flex flex-row justify-between items-center p-3 border-b border-white/10 shrink-0">
        <div className="flex items-center gap-4 text-gray-400">
          ...
          <button
            className="hover:text-white transition-colors md:hidden" // Chỉ hiện thị nút Back rõ ràng trên mobile nếu muốn, hoặc để luôn hiện
            title="Back to Inbox"
          >
        ...
        <div className="flex items-center gap-2 text-gray-400">
          ...
          <button className="p-2 hover:bg-white/10 rounded-md transition-colors hover:text-red-400">
            <BsTrash3 size={18} />
          </button>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
        ...
        <div className="flex flex-row justify-between items-start mb-6">
          ...
          <div className="flex items-center gap-2 text-gray-500 text-sm">
            ...
            <button className="p-1 hover:bg-white/10 rounded hover:text-white">
              <IoMdMore size={20} />
            </button>
          </div>
        </div>
      ...
      <div className="absolute bottom-6 left-6 flex flex-row gap-3">
        <button className="flex items-center gap-2 px-4 py-2 bg-[#2c2c2c] hover:bg-[#383838] text-gray-200 text-sm rounded border border-white/10 transition-colors">
          <FaReply /> Reply
        </button>
        <button className="flex items-center gap-2 px-4 py-2 bg-[#2c2c2c] hover:bg-[#383838] text-gray-200 text-sm rounded border border-white/10 transition-colors">
          <FaShare /> Forward
